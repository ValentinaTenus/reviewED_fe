  ...
  return (
    <div className={styles['baner_block']}>
      <div className={styles['baner_block_text']}>
        <h1 className={styles['header']}>Тільки перевірені відгуки про
          {' '}
          <span className={styles['header_yellow_text']}>компанії або курси</span>
        </h1>
        <p className={styles['text']}>
          Ви також можете відіслати власний відгук про компанію чи курс. 

...
const ReviewHeader: React.FC<ReviewHeaderProperties> = ({date, name, rating, role}) => {
	return (
		<div className={styles["review__header"]}>
			...
			<Icon className={styles["review__verification-icon"]} name={IconName.SHIELD_TICK}/>	<p className={styles["review__verification-text"]}>Verified Via LinkedIn</p> 
			</section>
